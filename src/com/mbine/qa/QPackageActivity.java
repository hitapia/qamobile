...
public class QPackageActivity extends FragmentActivity implements
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.qpackage, menu);
        return true;
    }
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			*/
	        ...
	        args.putString(TAG_PNO, mPNO);
			switch(position) {
			case 0:
				fragment = new QIActivity(getBaseContext()); break;
			case 1:
	...
	public static class DummySectionFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View rootView = inflater.inflate(R.layout.fragment_package_dummy,
					container, false);
